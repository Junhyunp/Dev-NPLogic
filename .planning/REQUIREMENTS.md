...
- [x] **QA-HOME-01**: 전체 탭 QA 요약 카드를 동일한 n×4 표 형식으로 교체
- [x] **QA-HOME-02**: 현재 물건에 대한 QA만 필터하여 표시

### UI — QA집계 탭

- [x] **QA-AGG-01**: QA집계 탭을 n×6 표로 교체 (차주번호/차주명/질의일자/질의내용/회신일자/답변내용)
- [x] **QA-AGG-02**: 전체 차주 대상 QA 조회 (물건 필터 없이 전체)
...
| QA-HOME-01 | Phase 2 | Complete |
| QA-HOME-02 | Phase 2 | Complete |
| QA-AGG-01 | Phase 2 | Complete |
| QA-AGG-02 | Phase 2 | Complete |
