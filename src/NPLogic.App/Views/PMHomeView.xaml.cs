...
namespace NPLogic.Views
{
    ...
    /// PM용 홈 화면
    /// </summary>
    public partial class PMHomeView : UserControl
    {
        public PMHomeView()
        {
            InitializeComponent();
        ...
        private async void PMHomeView_Loaded(object sender, RoutedEventArgs e)
        {
            if (DataContext is PMHomeViewModel viewModel)
            {
        ...
        private async void AssignComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (sender is ComboBox comboBox && 
                ...
                DataContext is PMHomeViewModel viewModel)
            {
