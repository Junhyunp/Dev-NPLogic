    ...
    public static class SheetMappingConfig
    {
        ...
        private static List<ColumnMappingRule> GetPropertyMappings()
        {
            return new List<ColumnMappingRule>
            {
                ...
                new("선순위 근저당권", "senior_mortgage_amount", false, ColumnDataType.Decimal),
                new("선순위근저당권", "senior_mortgage_amount", false, ColumnDataType.Decimal),
                new("유치권 신고금액", "lien_dd", false, ColumnDataType.Decimal),
                new("유치권신고금액", "lien_dd", false, ColumnDataType.Decimal),
                new("유치권\n신고금액", "lien_dd", false, ColumnDataType.Decimal),
